                        ...
                        Card(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                Icon(Icons.description,size: 35,color: Colors.grey[600],),
                                SizedBox(width: 10,),
                                Column(
                                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                        ...
                        Card(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: <Widget>[
                                Icon(Icons.collections_bookmark,size: 35,color: Colors.grey[600],),
                                SizedBox(width: 8,),
                                Column(
                                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                                  crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        Card(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: <Widget>[
                                Icon(Icons.file_download,size: 35,color: Colors.grey[600],),
                                SizedBox(width: 10,),
                                Column(
                                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                                  crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        Card(
                          ...
                          child: Container(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: <Widget>[
                                Icon(Icons.style,size: 35,color: Colors.grey[600],),
                                SizedBox(width: 10,),
                                Column(
                                  mainAxisAlignment: MainAxisAlignment.spaceAround,
                                  crossAxisAlignment: CrossAxisAlignment.start,
                        ...
                        return Row(
                          children: [
                            Container(
                              ...
                              width: MediaQuery.of(context).size.width*0.9,
                              child: Center(
                              child:Text('${apnt['username']}' + "has booked "+'${apnt['style']}')
                              ),
